 ...
 * Uses CSS var(--accent) for the teal colour so it adapts to themes.
 */
export function LogoMark({ size = 28, className }: LogoMarkProps) {
  return (
    ...
    >
      ...
      />
      {/* Waist bars */}
      <rect x="13" y="14" width="6" height="1.5" rx="0.75" fill="#fff" fillOpacity="0.85" />
      <rect x="13" y="16.5" width="6" height="1.5" rx="0.75" fill="#fff" fillOpacity="0.5" />
